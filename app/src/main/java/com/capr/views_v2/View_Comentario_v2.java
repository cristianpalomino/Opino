 ...
 */
public class View_Comentario_v2 extends View_Opino implements TextWatcher {

    private EditText edtcomentario;
    private TextView nombre;

    public View_Comentario_v2(Context context) {
        super(context, R.layout.view_comentario);
    }

    public View_Comentario_v2(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr, R.layout.view_comentario);
    }

    public View_Comentario_v2(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes, R.layout.view_comentario);
    }

    public View_Comentario_v2(Context context, AttributeSet attrs) {
