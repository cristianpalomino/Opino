 ...
 */
public class View_Rango_v2 extends View_Opino implements PopupMenu.OnMenuItemClickListener, View_Opcion_Rango.OnItemClick {
    ...
    public View_Rango_v2(Context context) {
        super(context, R.layout.view_rango);
    }

    public View_Rango_v2(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr, R.layout.view_rango);
    }

    public View_Rango_v2(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes, R.layout.view_rango);
    }

    public View_Rango_v2(Context context, AttributeSet attrs) {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        popup.dismiss();
        switch (position){
            case 0: getRespuesta_dto().setRespuesta("1");
                btnrango.setText("1");
                break;
            case 1: getRespuesta_dto().setRespuesta("2");
                btnrango.setText("2");
                break;
            case 2: getRespuesta_dto().setRespuesta("3");
                btnrango.setText("3");
                break;
            case 3: getRespuesta_dto().setRespuesta("4");
                btnrango.setText("4");
                break;
            case 4: getRespuesta_dto().setRespuesta("5");
                btnrango.setText("5");
                break;
        }
    }
