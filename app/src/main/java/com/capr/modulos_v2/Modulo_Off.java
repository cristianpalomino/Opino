 ...
 */
public class Modulo_Off implements OnSuccessLocales, OnSuccessVariables, OnSuccessEncuestas {

    public Activity activity;

    public Modulo_Off(Activity activity) {
        this.activity = activity;
    }

    public void startLocalesOff() {
        ...
        service_locales.sendRequestOff();

        /** Se muestra el FlatButton **/
        local.flatbutton.setVisibility(View.VISIBLE);
    }

    public void startVariablesOff() {
        ...
        service_variables.sendRequestOff(variable.getLocal_dto());
    }

    public void startEncuestasOff(String idLocal, String idVariable) {
        ...
        service_encuestas.sendRequestOff(idLocal, idVariable);
    }
